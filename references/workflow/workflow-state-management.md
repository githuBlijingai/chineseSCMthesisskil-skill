...
| `sample-template-analysis.md` | Sample/template analysis report containing parser status, template rules, sample patterns, outline suggestions, and word budget; **if user template has clear outline, it takes priority over default recommendations** |
