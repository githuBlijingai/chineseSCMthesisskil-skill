...
def render_sample_template_analysis(model: AnalysisModel) -> str:
    ...
    return "\n\n".join(
        [
            ...
            "## Outline Suggestion",
            "**Priority Rule**: If the user-provided template/task book contains a clear chapter outline, that outline takes precedence over default recommendations. Only use default chapter patterns when the user template lacks a clear structure.",
