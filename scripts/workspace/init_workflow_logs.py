...
**Priority Rule**: If the user-provided template, task book, or proposal contains a clear chapter outline, that outline takes precedence over default recommendations. Only use default chapter patterns when the user template lacks a clear structure.
